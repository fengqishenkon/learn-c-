...
//	//vector<int>::iterator itBegin = v.begin();    //itBegin是起始迭代器  指向容器中第一个元素的位置
//	//vector<int>::iterator itEnd = v.end();        //itEnd是结束迭代器，指向容器中最后一个元素的下一个位置
//
//	////第一种遍历方式
//	//while (itBegin != itEnd)
//	//{
